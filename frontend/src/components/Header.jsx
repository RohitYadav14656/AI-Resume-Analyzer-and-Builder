...
export default function Header({
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (e) => {
      if (!e.target.closest(".site-header") && !e.target.closest(".mobile-dropdown-container")) {
          ...
          <div className="mobile-dropdown-trigger-box">
            <button
              ...
              style={{
                ...
                borderRadius: "14px",
                background: mobileMenuOpen ? "rgba(217, 119, 6, 0.12)" : "rgba(255, 255, 255, 0.8)",
            ...
            >
              {user ? (
                <div style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
                  <div style={{ width: "24px", height: "24px", borderRadius: "50%", background: "var(--accent)", color: "white", fontSize: "0.75rem", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800 }}>
          ...
          {mobileMenuOpen && (
            <div
              ...
              style={{
                ...
                borderRadius: "20px",
                boxShadow: "0 20px 45px -10px rgba(15, 23, 42, 0.18), 0 4px 16px rgba(217, 119, 6, 0.08)",
                padding: "1rem",
                zIndex: 9999,
